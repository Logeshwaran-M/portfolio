...
export default function Typewriter({ phrases = ["Logeshwaran", "MERN Developer"], prefix = "Hi, I'm " }) {
  ...
  return (
    <h1 className="text-2xl md:text-5xl font-semibold text-green-500" aria-live="polite">
      {prefix}
